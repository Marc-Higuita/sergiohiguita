    ...
    <div ref={containerRef} className="relative w-full min-h-screen lg:h-screen bg-[#E8F4FC] overflow-x-hidden">
      ...
      <div className="relative flex lg:hidden flex-col items-center w-full min-h-screen bg-gradient-to-b from-[#E8F4FC] via-[#152641]/60 to-[#152641] text-[#152641] pt-12 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center gap-1 text-center mb-5">
          ...
          <h2 className="text-2xl sm:text-3xl font-black tracking-tighter uppercase text-[#152641]">
            SERGIO'S <span className="text-[#136CFC]">SPECIALTIES</span>
          </h2>
        </div>
        ...
        <div className="relative z-10 w-full max-w-sm h-[220px] rounded-xl overflow-hidden border border-[#136CFC]/40 shadow-xl mb-4 bg-[#152641]">
          <img
            ...
            className="w-full h-full object-cover object-center filter contrast-[1.08] brightness-90"
          />
      ...
      <div
        ref={overlayRef}
        className="hidden lg:flex absolute inset-0 w-full h-full bg-[#152641] text-[#E8F4FC] flex-col items-center justify-between py-12 z-30 select-none font-sans"
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-center pointer-events-none z-0 overflow-hidden leading-none opacity-15 space-y-8">
          <div className="flex whitespace-nowrap overflow-hidden">
            <motion.div
              ...
              animate={{ x: ["0%", "-50%"] }}
              transition={{ repeat: Infinity, duration: 25, ease: "linear" }}
              className="flex whitespace-nowrap text-[14rem] font-black uppercase tracking-tighter text-[#C3F84A]"
            >
              <span>{textRowOne}</span>
              <span>{textRowOne}</span>
            </motion.div>
          ...
          <div className="flex whitespace-nowrap overflow-hidden">
            <motion.div
              ...
              animate={{ x: ["-50%", "0%"] }}
              transition={{ repeat: Infinity, duration: 30, ease: "linear" }}
              className="flex whitespace-nowrap text-[14rem] font-black uppercase tracking-tighter text-[#136CFC] italic"
            >
              <span>{textRowTwo}</span>
              <span>{textRowTwo}</span>
            </motion.div>
        ...
        <motion.div 
          ...
          className="relative z-20 flex flex-col items-center gap-1.5 pt-4 text-center pointer-events-none px-4"
        >
        ...
        <div className="relative z-10 w-full max-w-6xl h-[72vh] flex items-center justify-center p-4 my-auto">
          <motion.div
